package stimmax.lessons.lesson04.homework
...
// Для типа Boolean значение переменной должно начинаться с маленькой буквы
//val v6 = FALSE
val v7: Char = 'c'
val v8: Int = 500
...
// Для типа Boolean значение без кавычек, если хотим именно такое значение строки, то будет тип String
val v13: String = "true"
